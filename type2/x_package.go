...
func init() {
	imports.Packages["github.com/cosmos72/gomacro/type2"] = imports.Package{
		Binds: map[string]r.Value{
			...
			"KeepReflectType":     r.ValueOf(KeepReflectType),
			...
			"RebuildReflectType1": r.ValueOf(RebuildReflectType1),
