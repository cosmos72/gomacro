	...
	case r.Int32:
		...
		case r.Bool:
			...
			if funsym != nil && funupn == maxdepth-1 {
				...
				if funsym != nil && funupn == 0 {
					ret = func(env *Env) int32 {
						fun := env.Vals[funindex].Interface().(func(bool) int32)
						arg := argfun(env)
						return fun(arg)
					}
				} else if funsym != nil && funupn == 1 {
					ret = func(env *Env) int32 {
						fun := env.Outer.Vals[funindex].Interface().(func(bool) int32)
						arg := argfun(env)
						return fun(arg)
					}
				} else {
		...
		case r.Int:
			...
			if funsym != nil && funupn == maxdepth-1 {
				...
				if funsym != nil && funupn == 0 {
					ret = func(env *Env) int32 {
						fun := env.Vals[funindex].Interface().(func(int) int32)
						arg := argfun(env)
						return fun(arg)
					}
				} else if funsym != nil && funupn == 1 {
					ret = func(env *Env) int32 {
						fun := env.Outer.Vals[funindex].Interface().(func(int) int32)
						arg := argfun(env)
						return fun(arg)
					}
				} else {
		...
		case r.Int8:
			...
			if funsym != nil && funupn == maxdepth-1 {
				...
				if funsym != nil && funupn == 0 {
					ret = func(env *Env) int32 {
						fun := env.Vals[funindex].Interface().(func(int8) int32)
						arg := argfun(env)
						return fun(arg)
					}
				} else if funsym != nil && funupn == 1 {
					ret = func(env *Env) int32 {
						fun := env.Outer.Vals[funindex].Interface().(func(int8) int32)
						arg := argfun(env)
						return fun(arg)
					}
				} else {
		...
		case r.Int16:
			...
			if funsym != nil && funupn == maxdepth-1 {
				...
				if funsym != nil && funupn == 0 {
					ret = func(env *Env) int32 {
						fun := env.Vals[funindex].Interface().(func(int16) int32)
						arg := argfun(env)
						return fun(arg)
					}
				} else if funsym != nil && funupn == 1 {
					ret = func(env *Env) int32 {
						fun := env.Outer.Vals[funindex].Interface().(func(int16) int32)
						arg := argfun(env)
						return fun(arg)
					}
				} else {
		...
		case r.Int64:
			...
			if funsym != nil && funupn == maxdepth-1 {
				...
				if funsym != nil && funupn == 0 {
					ret = func(env *Env) int32 {
						fun := env.Vals[funindex].Interface().(func(int64) int32)
						arg := argfun(env)
						return fun(arg)
					}
				} else if funsym != nil && funupn == 1 {
					ret = func(env *Env) int32 {
						fun := env.Outer.Vals[funindex].Interface().(func(int64) int32)
						arg := argfun(env)
						return fun(arg)
					}
				} else {
		...
		case r.Uint:
			...
			if funsym != nil && funupn == maxdepth-1 {
				...
				if funsym != nil && funupn == 0 {
					ret = func(env *Env) int32 {
						fun := env.Vals[funindex].Interface().(func(uint) int32)
						arg := argfun(env)
						return fun(arg)
					}
				} else if funsym != nil && funupn == 1 {
					ret = func(env *Env) int32 {
						fun := env.Outer.Vals[funindex].Interface().(func(uint) int32)
						arg := argfun(env)
						return fun(arg)
					}
				} else {
		...
		case r.Uint8:
			...
			if funsym != nil && funupn == maxdepth-1 {
				...
				if funsym != nil && funupn == 0 {
					ret = func(env *Env) int32 {
						fun := env.Vals[funindex].Interface().(func(uint8) int32)
						arg := argfun(env)
						return fun(arg)
					}
				} else if funsym != nil && funupn == 1 {
					ret = func(env *Env) int32 {
						fun := env.Outer.Vals[funindex].Interface().(func(uint8) int32)
						arg := argfun(env)
						return fun(arg)
					}
				} else {
		...
		case r.Uint16:
			...
			if funsym != nil && funupn == maxdepth-1 {
				...
				if funsym != nil && funupn == 0 {
					ret = func(env *Env) int32 {
						fun := env.Vals[funindex].Interface().(func(uint16) int32)
						arg := argfun(env)
						return fun(arg)
					}
				} else if funsym != nil && funupn == 1 {
					ret = func(env *Env) int32 {
						fun := env.Outer.Vals[funindex].Interface().(func(uint16) int32)
						arg := argfun(env)
						return fun(arg)
					}
				} else {
		...
		case r.Uint32:
			...
			if funsym != nil && funupn == maxdepth-1 {
				...
				if funsym != nil && funupn == 0 {
					ret = func(env *Env) int32 {
						fun := env.Vals[funindex].Interface().(func(uint32) int32)
						arg := argfun(env)
						return fun(arg)
					}
				} else if funsym != nil && funupn == 1 {
					ret = func(env *Env) int32 {
						fun := env.Outer.Vals[funindex].Interface().(func(uint32) int32)
						arg := argfun(env)
						return fun(arg)
					}
				} else {
		...
		case r.Uint64:
			...
			if funsym != nil && funupn == maxdepth-1 {
				...
				if funsym != nil && funupn == 0 {
					ret = func(env *Env) int32 {
						fun := env.Vals[funindex].Interface().(func(uint64) int32)
						arg := argfun(env)
						return fun(arg)
					}
				} else if funsym != nil && funupn == 1 {
					ret = func(env *Env) int32 {
						fun := env.Outer.Vals[funindex].Interface().(func(uint64) int32)
						arg := argfun(env)
						return fun(arg)
					}
				} else {
		...
		case r.Uintptr:
			...
			if funsym != nil && funupn == maxdepth-1 {
				...
				if funsym != nil && funupn == 0 {
					ret = func(env *Env) int32 {
						fun := env.Vals[funindex].Interface().(func(uintptr) int32)
						arg := argfun(env)
						return fun(arg)
					}
				} else if funsym != nil && funupn == 1 {
					ret = func(env *Env) int32 {
						fun := env.Outer.Vals[funindex].Interface().(func(uintptr) int32)
						arg := argfun(env)
						return fun(arg)
					}
				} else {
		...
		case r.Float32:
			...
			if funsym != nil && funupn == maxdepth-1 {
				...
				if funsym != nil && funupn == 0 {
					ret = func(env *Env) int32 {
						fun := env.Vals[funindex].Interface().(func(float32) int32)
						arg := argfun(env)
						return fun(arg)
					}
				} else if funsym != nil && funupn == 1 {
					ret = func(env *Env) int32 {
						fun := env.Outer.Vals[funindex].Interface().(func(float32) int32)
						arg := argfun(env)
						return fun(arg)
					}
				} else {
		...
		case r.Float64:
			...
			if funsym != nil && funupn == maxdepth-1 {
				...
				if funsym != nil && funupn == 0 {
					ret = func(env *Env) int32 {
						fun := env.Vals[funindex].Interface().(func(float64) int32)
						arg := argfun(env)
						return fun(arg)
					}
				} else if funsym != nil && funupn == 1 {
					ret = func(env *Env) int32 {
						fun := env.Outer.Vals[funindex].Interface().(func(float64) int32)
						arg := argfun(env)
						return fun(arg)
					}
				} else {
		...
		case r.Complex64:
			...
			if funsym != nil && funupn == maxdepth-1 {
				...
				if funsym != nil && funupn == 0 {
					ret = func(env *Env) int32 {
						fun := env.Vals[funindex].Interface().(func(complex64) int32)
						arg := argfun(env)
						return fun(arg)
					}
				} else if funsym != nil && funupn == 1 {
					ret = func(env *Env) int32 {
						fun := env.Outer.Vals[funindex].Interface().(func(complex64) int32)
						arg := argfun(env)
						return fun(arg)
					}
				} else {
		...
		case r.Complex128:
			...
			if funsym != nil && funupn == maxdepth-1 {
				...
				if funsym != nil && funupn == 0 {
					ret = func(env *Env) int32 {
						fun := env.Vals[funindex].Interface().(func(complex128) int32)
						arg := argfun(env)
						return fun(arg)
					}
				} else if funsym != nil && funupn == 1 {
					ret = func(env *Env) int32 {
						fun := env.Outer.Vals[funindex].Interface().(func(complex128) int32)
						arg := argfun(env)
						return fun(arg)
					}
				} else {
		...
		case r.String:
			...
			if funsym != nil && funupn == maxdepth-1 {
				...
				if funsym != nil && funupn == 0 {
					ret = func(env *Env) int32 {
						fun := env.Vals[funindex].Interface().(func(string) int32)
						arg := argfun(env)
						return fun(arg)
					}
				} else if funsym != nil && funupn == 1 {
					ret = func(env *Env) int32 {
						fun := env.Outer.Vals[funindex].Interface().(func(string) int32)
						arg := argfun(env)
						return fun(arg)
					}
				} else {
