	...
	for _, t := range v.BasicTypes {
		...
		case r.Int32:
			for i, n := 0, xt.NumMethod(); i < n; i++ {
				switch xt.Method(i).Name {
				case "Equal":
					(*mvec)[i] = r.ValueOf(func(a int32, b int32) bool { return a == b })
				case "Less":
		...
		case r.Int64:
			for i, n := 0, xt.NumMethod(); i < n; i++ {
				switch xt.Method(i).Name {
				case "Equal":
					(*mvec)[i] = r.ValueOf(func(a int64, b int64) bool { return a == b })
				case "Less":
					(*mvec)[i] = r.ValueOf(func(a int64, b int64) bool { return a < b })
				case "Add":
		...
		case r.Uint:
			for i, n := 0, xt.NumMethod(); i < n; i++ {
				...
				case "Less":
					(*mvec)[i] = r.ValueOf(func(a uint, b uint) bool { return a < b })
				case "Add":
					(*mvec)[i] = r.ValueOf(func(a uint, b uint) uint { return a + b })
				case "Sub":
		...
		case r.Uint8:
			for i, n := 0, xt.NumMethod(); i < n; i++ {
				...
				case "Less":
					(*mvec)[i] = r.ValueOf(func(a uint8, b uint8) bool { return a < b })
				case "Add":
					(*mvec)[i] = r.ValueOf(func(a uint8, b uint8) uint8 {
						return a + b
					})
				case "Sub":
					(*mvec)[i] = r.ValueOf(func(a uint8, b uint8) uint8 { return a - b })
				case "Mul":
		...
		case r.Uint16:
			for i, n := 0, xt.NumMethod(); i < n; i++ {
				...
				case "Less":
					(*mvec)[i] = r.ValueOf(func(a uint16, b uint16) bool { return a < b })
				case "Add":
					(*mvec)[i] = r.ValueOf(func(a uint16, b uint16) uint16 {
						return a + b
					})
				case "Sub":
					(*mvec)[i] = r.ValueOf(func(a uint16, b uint16) uint16 {
		...
		case r.Uint64:
			for i, n := 0, xt.NumMethod(); i < n; i++ {
				...
				case "Neg":
					(*mvec)[i] = r.ValueOf(func(a uint64) uint64 { return -a })
				case "Rem":
		...
		case r.Uintptr:
			for i, n := 0, xt.NumMethod(); i < n; i++ {
				...
				case "Neg":
					(*mvec)[i] = r.ValueOf(func(a uintptr) uintptr {
						return -a
					})
				case "Rem":
