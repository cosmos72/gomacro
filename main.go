...
func main() {
	...
	cmd.Options |= gmi.OptTrapPanic & 0 // | gmi.OptShowAfterParse // |gmi.OptShowAfterMacroExpansion // | gmi.OptDebugMacroExpand // |  gmi.OptDebugQuasiquote  // | gmi.OptShowEvalDuration
