...
func main() {
	...
	cmd.Options = gmi.OptShowAfterParse // | gmi.OptTrapPanic | gmi.OptShowAfterMacroExpansion // | gmi.OptDebugMacroExpand // |  gmi.OptDebugQuasiquote  // | gmi.OptShowEvalDuration
