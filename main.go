...
func Main(args []string) {
	...
	env.Options = gmi.OptTrapPanic // | gmi.OptShowAfterMacroExpansion // | gmi.OptDebugMacroExpand // |  gmi.OptDebugQuasiquote  // | gmi.OptShowEvalDuration // | gmi.OptShowAfterParse
