...
func init() {
	...
	Binds: map[string]Value{
		...
		"CLONE_IO":	ValueOf(syscall.CLONE_IO),
		...
		"IN_CLASSA_NET":	ValueOf(syscall.IN_CLASSA_NET),
		...
		"IN_ONESHOT":	ValueOf(syscall.IN_ONESHOT),
		...
		"LINUX_REBOOT_CMD_CAD_ON":	ValueOf(syscall.LINUX_REBOOT_CMD_CAD_ON),
		"LINUX_REBOOT_CMD_HALT":	ValueOf(syscall.LINUX_REBOOT_CMD_HALT),
		...
		"LINUX_REBOOT_CMD_RESTART2":	ValueOf(syscall.LINUX_REBOOT_CMD_RESTART2),
		"LINUX_REBOOT_CMD_SW_SUSPEND":	ValueOf(syscall.LINUX_REBOOT_CMD_SW_SUSPEND),
		"LINUX_REBOOT_MAGIC1":	ValueOf(syscall.LINUX_REBOOT_MAGIC1),
		...
		"MS_MGC_MSK":	ValueOf(syscall.MS_MGC_MSK),
		"MS_MGC_VAL":	ValueOf(syscall.MS_MGC_VAL),
		...
		"RTF_ADDRCLASSMASK":	ValueOf(syscall.RTF_ADDRCLASSMASK),
		...
		"RT_TABLE_MAX":	ValueOf(syscall.RT_TABLE_MAX),
		...
		"TIOCGDEV":	ValueOf(syscall.TIOCGDEV),
		...
		"TUNGETFEATURES":	ValueOf(syscall.TUNGETFEATURES),
		"TUNGETIFF":	ValueOf(syscall.TUNGETIFF),
		"TUNGETSNDBUF":	ValueOf(syscall.TUNGETSNDBUF),
		"TUNGETVNETHDRSZ":	ValueOf(syscall.TUNGETVNETHDRSZ),
