...
func init() {
	Packages["testing"] = Package{
		...
		Binds: map[string]Value{
			...
			"B":	[]string{"Cleanup","Error","Errorf","Fail","FailNow","Failed","Fatal","Fatalf","Helper","Log","Logf","Name","Setenv","Skip","SkipNow","Skipf","Skipped","TempDir",},
			"F":	[]string{"Cleanup","Error","Errorf","FailNow","Failed","Fatal","Fatalf","Log","Logf","Name","Setenv","Skip","SkipNow","Skipf","TempDir",},
			"T":	[]string{"Cleanup","Error","Errorf","Fail","FailNow","Failed","Fatal","Fatalf","Helper","Log","Logf","Name","Skip","SkipNow","Skipf","Skipped","TempDir",},
		}, 
	}
}
