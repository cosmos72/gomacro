...
func init() {
	imports.Packages["github.com/cosmos72/gomacro/ast2"] = imports.Package{
		...
		Proxies: map[string]r.Type{
			"Ast":          r.TypeOf((*Ast_proxy)(nil)).Elem(),
			"AstWithNode":  r.TypeOf((*AstWithNode_proxy)(nil)).Elem(),
			"AstWithSlice": r.TypeOf((*AstWithSlice_proxy)(nil)).Elem(),
		}}
}

// --------------- proxy for github.com/cosmos72/gomacro/Ast ---------------
type Ast_proxy struct {
	Object     interface{}
	Get_       func(i int) Ast
...
func (Proxy Ast_proxy) Get(i int) Ast {
	return Proxy.Get_(i)
}
func (Proxy Ast_proxy) Interface() interface{} {
	return Proxy.Interface_()
}
func (Proxy Ast_proxy) New() Ast {
	return Proxy.New_()
}
func (Proxy Ast_proxy) Op() token.Token {
	return Proxy.Op_()
}
func (Proxy Ast_proxy) Set(i int, child Ast) {
	Proxy.Set_(i, child)
}
func (Proxy Ast_proxy) Size() int {
	return Proxy.Size_()
}

// --------------- proxy for github.com/cosmos72/gomacro/AstWithNode ---------------
type AstWithNode_proxy struct {
	Object     interface{}
	Get_       func(i int) Ast
	Interface_ func() interface{}
	New_       func() Ast
...
func (Proxy AstWithNode_proxy) Get(i int) Ast {
	return Proxy.Get_(i)
}
func (Proxy AstWithNode_proxy) Interface() interface{} {
	return Proxy.Interface_()
}
func (Proxy AstWithNode_proxy) New() Ast {
	return Proxy.New_()
}
func (Proxy AstWithNode_proxy) Node() ast.Node {
	return Proxy.Node_()
}
func (Proxy AstWithNode_proxy) Op() token.Token {
	return Proxy.Op_()
}
func (Proxy AstWithNode_proxy) Set(i int, child Ast) {
	Proxy.Set_(i, child)
}
func (Proxy AstWithNode_proxy) Size() int {
	return Proxy.Size_()
}

// --------------- proxy for github.com/cosmos72/gomacro/AstWithSlice ---------------
type AstWithSlice_proxy struct {
	Object     interface{}
...
func (Proxy AstWithSlice_proxy) Append(child Ast) AstWithSlice {
	return Proxy.Append_(child)
}
func (Proxy AstWithSlice_proxy) Get(i int) Ast {
	return Proxy.Get_(i)
}
func (Proxy AstWithSlice_proxy) Interface() interface{} {
	return Proxy.Interface_()
}
func (Proxy AstWithSlice_proxy) New() Ast {
	return Proxy.New_()
}
func (Proxy AstWithSlice_proxy) Op() token.Token {
	return Proxy.Op_()
}
func (Proxy AstWithSlice_proxy) Set(i int, child Ast) {
	Proxy.Set_(i, child)
}
func (Proxy AstWithSlice_proxy) Size() int {
	return Proxy.Size_()
}
func (Proxy AstWithSlice_proxy) Slice(lo int, hi int) AstWithSlice {
