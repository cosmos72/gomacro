...
func (c *Comp) neqMisc(node *ast.BinaryExpr, xe *Expr, ye *Expr) *Expr {
...
func (c *Comp) neqNil(node *ast.BinaryExpr, xe *Expr, ye *Expr) *Expr {
	var e *Expr
	if ye.IsNil {
		e = xe
	} else {
