...
func shrYUint16(x uint16, y I) I {
	switch y := y.(type) {
	case func(*Env) uint:
...
func shrYUint32(x uint32, y I) I {
	switch y := y.(type) {
	case func(*Env) uint:
...
func shrYUint64(x uint64, y I) I {
	switch y := y.(type) {
	case func(*Env) uint:
...
func shrYUintptr(x uintptr, y I) I {
	switch y := y.(type) {
	case func(*Env) uint:
