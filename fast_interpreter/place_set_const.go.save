...
func (c *Comp) placeSetConst(place *Place, init *Expr) {
	...
	case VarBind:
		...
		case 0:
			...
			case complex128:
				ret = func(env *Env) (Stmt, *Env) {
					env.Binds[index].SetComplex(val)
					env.IP++
					return env.Code[env.IP], env
				}
			case string:
				ret = func(env *Env) (Stmt, *Env) {
					env.Binds[index].SetString(val)
					env.IP++
					return env.Code[env.IP], env
				}
			default:
		...
		case 1:
			...
			case complex128:
				ret = func(env *Env) (Stmt, *Env) {
					env.Outer.Binds[index].SetComplex(val)
					env.IP++
					return env.Code[env.IP], env
				}
			case string:
				ret = func(env *Env) (Stmt, *Env) {
					env.Outer.Binds[index].SetString(val)
					env.IP++
					return env.Code[env.IP], env
				}
			default:
		...
		case 2:
			...
			case complex128:
				ret = func(env *Env) (Stmt, *Env) {
					env.Outer.Outer.Binds[index].SetComplex(val)
					env.IP++
					return env.Code[env.IP], env
				}
			case string:
				ret = func(env *Env) (Stmt, *Env) {
					env.Outer.Outer.Binds[index].SetString(val)
					env.IP++
					return env.Code[env.IP], env
				}
			default:
	...
	case IntBind:
		...
		case 1:
			...
			case bool:
				ret = func(env *Env) (Stmt, *Env) {
					*(*bool)(unsafe.Pointer(&env.Outer.IntBinds[index])) = value
					env.IP++
					return env.Code[env.IP], env
				}
			case int:
		...
		case 2:
			...
			case bool:
				ret = func(env *Env) (Stmt, *Env) {
					*(*bool)(unsafe.Pointer(&env.Outer.Outer.IntBinds[index])) = value
					env.IP++
					return env.Code[env.IP], env
				}
			case int:
		...
		default:
			...
			case bool:
				ret = func(env *Env) (Stmt, *Env) {
					...
					*(*bool)(unsafe.Pointer(&o.IntBinds[index])) = value
					env.IP++
					return env.Code[env.IP], env
				}
			case int:
