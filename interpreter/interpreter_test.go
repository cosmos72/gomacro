...
var testcases = []TestCase{
	...
	TestCase{"method_on_ptr", "func (p *Pair) SetLhs(a int) { p.A = a }; pair.SetLhs(8); pair.A", 8, nil},
	TestCase{"method_on_value", "func (p Pair) SetLhs(a int) { p.A = a }; pair.SetLhs(11); pair.A", 8, nil}, // method on value gets a copy of the receiver - changes to not propagate
	...
	TestCase{"recover_nested_2", `vpanic, vpanic2, vpanic3 = nil, nil, nil
