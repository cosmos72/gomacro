...
func init() {
	imports.Binds["github.com/cosmos72/gomacro/interpreter"] = map[string]r.Value{
	...
	imports.Types["github.com/cosmos72/gomacro/interpreter"] = map[string]r.Type{
	...
	imports.Proxies["github.com/cosmos72/gomacro/interpreter"] = map[string]r.Type{}
}
